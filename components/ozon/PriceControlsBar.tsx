          ...
          <div className="flex flex-col gap-2 text-[12px] text-slate-700">
            <div className="inline-flex items-center gap-4">
              ...
              <div className="inline-flex items-center gap-1 select-none">
                ...
                <Button size="sm" variant="ghost" className="ml-1" onClick={()=> setMoreOpen(true)}>更多模型</Button>
              </div>
            </div>
            {/* 模型1参数：仅在 CE 选中时显示 */}
            {demandModel === 'ce' && (
      ...
      <Dialog open={moreOpen} onOpenChange={setMoreOpen}>
        <DialogContent>
          ...
          <div className="text-sm leading-6 text-slate-700">
            ...
            <br/>如果你愿意与我们共创，请与我们联系，告诉我们你的场景与数据需求，我们会优先为你打磨最有价值的模型，并向全体用户免费开放，帮助更多卖家更好地定价。
          </div>
          <div className="text-xs text-slate-500">你可以点击右下角“反馈”按钮留言，或发送邮件至 support@xixisys.com</div>
